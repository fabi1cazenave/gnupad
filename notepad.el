...
;| It reuses a subset of ErgoEmacs but tries to remain as simple as possible.
;|
;| Known problems:
;|   * the undo/redo stack still sucks!
;|   * [F3]/Shift+[F3] (next/previous search occurrences) still not implemented
;|   * it would be nice if this configuration file could be activated /
;|     disactivated along with cua-mode.
;|
...
;; Selection with Shift+[arrow] -- blatantly stolen from ErgoEmacs
;; not working with Org-mode :-/
...
;; Bonus: cut/copy the current line when no selection is made
